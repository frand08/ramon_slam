 ...
 *  none.
 */
AccelCalibration::AccelCalibration(Eigen::Vector3d noise)
{
    Eigen::Matrix3d T_init;
    Eigen::Matrix3d K_init;
    Eigen::Vector3d b_init;
 ...
 *  none.
 */
AccelCalibration::AccelCalibration(Eigen::Matrix3d T_init, Eigen::Matrix3d K_init, Eigen::Vector3d b_init)
{
    Eigen::Vector3d noise;
 ...
 *  none.
 */
AccelCalibration::AccelCalibration(Eigen::Matrix3d T_init, Eigen::Matrix3d K_init, Eigen::Vector3d b_init, Eigen::Vector3d noise)
{
    // Set initial values
    this->setInitalValues(T_init, K_init, b_init);
 ...
 */
Eigen::LevenbergMarquardtSpace::Status AccelCalibration::calibrate(const Eigen::Ref<const Eigen::MatrixXd> accel_values)
{
    ...
    Eigen::LevenbergMarquardt<Eigen::NumericalDiff<accel_cal_functor>, double> lm(numDiff);
    // accel_cal_functor functor;
    // Eigen::LevenbergMarquardtSpace::Status ret;
    // Eigen::LevenbergMarquardt<accel_cal_functor, double> lm(functor);
 ...
 */
int AccelCalibration::getBias(Eigen::Ref<Eigen::Vector3d> b)
{
    int out;
    if(calibrated_)
    {
 ...
 *  int - if the accelerometer was previously calibrated, returns 0, otherwise, -1
 */
int AccelCalibration::getParams(Eigen::Ref<Eigen::Matrix3d> T, Eigen::Ref<Eigen::Matrix3d> K, Eigen::Ref<Eigen::Vector3d> b)
{
    int ret = -1;
    if(calibrated_)
    {
 ...
 *  int - if the accelerometer was previously calibrated, returns 0, otherwise, -1
 */
int AccelCalibration::getK(Eigen::Ref<Eigen::Matrix3d> K)
{
    int out;
    if(calibrated_)
    {
 ...
 *  int - if the accelerometer was previously calibrated, returns 0, otherwise, -1
 */
int AccelCalibration::getT(Eigen::Ref<Eigen::Matrix3d> T)
{
    int out;
    if(calibrated_)
    {
 ...
 *  none.
 */
void AccelCalibration::setInitalValues(Eigen::Matrix3d T_init, Eigen::Matrix3d K_init, Eigen::Vector3d b_init)
{
    // axis missalignments (init values)
 ...
 *  none.
 */
void AccelCalibration::setNoise(Eigen::Vector3d noise)
{
    noise_ = noise;
    if(noise.norm() == 0.0)
        use_noise_ = false;
 ...
 *  int - if the accelerometer was previously calibrated, returns 0, otherwise, -1
 */
int AccelCalibration::correctValues(const Eigen::Ref<const Eigen::MatrixX3d> accel_values, Eigen::Ref<Eigen::MatrixX3d> accel_values_corr)
{
    int ret = -1;
    if(calibrated_)
    {
